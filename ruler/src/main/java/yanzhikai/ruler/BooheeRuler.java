...
//    private int mRulerBackGroundColor = getResources().getDrawable(R.drawable.ruler_shape);
    //是否启用边缘效应
...
//        mInnerRuler.setBackgroundColor(Color.parseColor("#666E84"));
        mInnerRuler.setBackgroundColor(Color.parseColor("#0000FF"));
