...
//                            // 进入这儿表示没有权限
//                            if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) v.getContext(), Manifest.permission.CAMERA)) {
//                                // 提示已经禁止
////                                ToastUtil.longToast(mContext, getString(R.string.you_have_cut_down_the_permission));
//                            } else {
                            ActivityCompat.requestPermissions((Activity) v.getContext(), new String[]{Manifest.permission.CAMERA}, 100);
//                            }
