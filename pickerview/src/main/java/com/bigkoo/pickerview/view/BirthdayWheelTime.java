...
import com.bigkoo.pickerview.BirthdayPickerView.Type;
...
public class BirthdayWheelTime {
...
//    private WheelView wv_seconds;
    ...
    public BirthdayWheelTime(View view) {
        super();
        this.view = view;
        type = Type.ALL;
        setView(view);
    ...
    public BirthdayWheelTime(View view, Type type, int gravity, int textSize) {
        super();
        this.view = view;
        this.type = type;
   ...
   public void setPicker(String left,int year, int month, int day,String right) {
        this.left=left;
        this.right=right;
        this.setPicker(year, month, day, 0, 0, 0);
    }
    ...
    public void setPicker(int year, final int month, int day, int h, int m, int s) {
      ...
      /*  final Context context = view.getContext();*/
        ...
        List<String> mOptions1Items=new ArrayList<String>();
        mOptions1Items.add("      ");

        wv_left.setAdapter(new ArrayWheelAdapter(mOptions1Items, 1));// 设置显示数据
        ...
        wv_right.setAdapter(new ArrayWheelAdapter(mOptions1Items, 1));// 设置显示数据
...
//        wv_seconds.setTextColorCenter(textColorCenter);
    ...
    private void setBGColorCenter() {

        wv_left.setBGColorCenter(bgColorCenter);
        wv_right.setBGColorCenter(bgColorCenter);
        wv_day.setBGColorCenter(bgColorCenter);
        wv_month.setBGColorCenter(bgColorCenter);
        wv_year.setBGColorCenter(bgColorCenter);
//        wv_hours.setBGColorCenter(bgColorCenter);
//        wv_mins.setBGColorCenter(bgColorCenter);
//        wv_seconds.setBGColorCenter(bgColorCenter);
...
//                    .append(wv_seconds.getCurrentItem());
     ...
     * @param bgColorCenter
     */
    public void setBGColorCenter(int bgColorCenter) {
