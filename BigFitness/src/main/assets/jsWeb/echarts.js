...
function(e) {
    ...
    return i.prototype = {
        _init: function() {
            ...
            (0 === i.getWidth() || 0 === i.getHeight()) && console.error("Dom鈥檚 width & height should be ready before init.")
        },
...
function(e) {
    ...
    return t.prototype = {
        ...
        __onSaveAsImage: function() {
            ...
            a.innerHTML = '<img style="vertical-align:middle" src="' + i + '" title="' + (window.ActiveXObject || "ActiveXObject" in window ? "鍙抽敭->鍥剧墖鍙﹀瓨涓�": e.lang ? e.lang[0] : "鐐瑰嚮淇濆瓨") + '"/>',
            n.appendChild(a),
