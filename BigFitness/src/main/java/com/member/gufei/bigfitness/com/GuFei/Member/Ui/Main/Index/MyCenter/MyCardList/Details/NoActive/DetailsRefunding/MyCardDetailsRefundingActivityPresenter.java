...
public class MyCardDetailsRefundingActivityPresenter extends RxPresenter<MyCardDetailsRefundingActivityContract.View> implements MyCardDetailsRefundingActivityContract.Presenter {
    ...
    @Inject
    public MyCardDetailsRefundingActivityPresenter(Api api) {
        this.api = api;
    }
