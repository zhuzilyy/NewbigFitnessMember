...
public class NumberCardRenewalOrderActivityPresenter extends RxPresenter<NumberCardRenewalOrderActivityContract.View> implements NumberCardRenewalOrderActivityContract.Presenter {
    ...
    @Inject
    public NumberCardRenewalOrderActivityPresenter(Api api) {
        this.api = api;
    }
