...
public class MyCourseListActivityPresenter extends RxPresenter<MyCourseListActivityContract.View> implements MyCourseListActivityContract.Presenter {
    ...
    @Inject
    public MyCourseListActivityPresenter(Api api) {
        this.api = api;
    }
