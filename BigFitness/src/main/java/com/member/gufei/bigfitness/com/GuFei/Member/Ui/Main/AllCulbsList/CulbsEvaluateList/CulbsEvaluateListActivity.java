...
public class CulbsEvaluateListActivity extends BaseActivity<CulbsEvaluateListActivityPresenter> implements CulbsEvaluateListActivityContract.View {
...
//        );
        mPresenter.getClubevaluateByClubId(String.valueOf(UserId),
                token, Clubid, rbShow.isChecked() ? 1 : 0, mStar, Page);
