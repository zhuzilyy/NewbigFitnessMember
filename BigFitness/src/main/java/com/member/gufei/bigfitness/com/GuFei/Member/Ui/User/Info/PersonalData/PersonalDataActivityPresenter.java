...
public class PersonalDataActivityPresenter extends RxPresenter<PersonalDataActivityContract.View> implements PersonalDataActivityContract.Presenter {
    ...
    @Inject
    public PersonalDataActivityPresenter(Api api) {
        this.api = api;
    }
