...
public class MyCardDetailsActiveActivityPresenter extends RxPresenter<MyCardDetailsActiveActivityContract.View> implements MyCardDetailsActiveActivityContract.Presenter {
    ...
    @Inject
    public MyCardDetailsActiveActivityPresenter(Api api) {
        this.api = api;
    }
