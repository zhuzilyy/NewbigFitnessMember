...
public class EditNameActivityPresenter extends RxPresenter<EditNameActivityContract.View> implements EditNameActivityContract.Presenter {
    ...
    @Inject
    public EditNameActivityPresenter(Api api) {
        this.api = api;
    }
