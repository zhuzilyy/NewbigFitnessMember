package com.member.gufei.bigfitness.com.GuFei.Member.Ui.ReservationRecordClass.MakeUpApply;
...
public class MakeUpApplyActivityPresenter extends RxPresenter<MakeUpApplyActivityContract.View> implements MakeUpApplyActivityContract.Presenter {
    ...
    @Inject
    public MakeUpApplyActivityPresenter(Api api) {
        this.api = api;
    }
