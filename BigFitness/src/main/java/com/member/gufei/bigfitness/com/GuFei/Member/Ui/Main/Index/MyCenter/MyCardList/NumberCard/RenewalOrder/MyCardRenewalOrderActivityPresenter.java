...
public class MyCardRenewalOrderActivityPresenter extends RxPresenter<MyCardRenewalOrderActivityContract.View> implements MyCardRenewalOrderActivityContract.Presenter {
    ...
    @Inject
    public MyCardRenewalOrderActivityPresenter(Api api) {
        this.api = api;
    }
