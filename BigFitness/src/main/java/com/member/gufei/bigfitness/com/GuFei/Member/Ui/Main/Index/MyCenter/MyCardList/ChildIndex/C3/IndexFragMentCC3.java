...
@RuntimePermissions
public class IndexFragMentCC3 extends BaseFragment<IndexFragMentCC3Presenter> implements IndexFragMentCC3Contract.View {
    ...
    private CommonAdapter<AppGetMyMemberCardListNotActiveBean.RowsBean.NotActivedListBean> commonAdapter;
    private List<AppGetMyMemberCardListNotActiveBean.RowsBean.NotActivedListBean> datas = new ArrayList<AppGetMyMemberCardListNotActiveBean.RowsBean.NotActivedListBean>();
...
//                refresh();
    ...
    public void initList() {
        ...
        commonAdapter = new CommonAdapter<AppGetMyMemberCardListNotActiveBean.RowsBean.NotActivedListBean>(R.layout.cardview_member_my_card, mContext, datas) {
            @Override
            protected void convert(final ViewHolder holder, final AppGetMyMemberCardListNotActiveBean.RowsBean.NotActivedListBean dataBean, int position) {
...
//        String UserName = (String) SpUtil.get(mContext, USERNAMEKEY, "");
        ...
        mPresenter.appGetMyMemberCardListNotActive(String.valueOf(UserId),
                ClubId, token, Page
        );
    }
...
//        noticeSystemBtn.setVisibility(View.GONE);
    ...
    @Override
    public void succeed(AppGetMyMemberCardListNotActiveBean appGetMyMemberCardListNotActiveBean) {

        swipeRefreshLayout.setRefreshing(false);
        if (appGetMyMemberCardListNotActiveBean.getRows().getNotActivedList().size() != 0) {
            datas = appGetMyMemberCardListNotActiveBean.getRows().getNotActivedList();
