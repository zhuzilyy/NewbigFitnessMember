...
public class MyCardDetailsFrozeningActivityPresenter extends RxPresenter<MyCardDetailsFrozeningActivityContract.View> implements MyCardDetailsFrozeningActivityContract.Presenter {
    ...
    @Inject
    public MyCardDetailsFrozeningActivityPresenter(Api api) {
        this.api = api;
    }
