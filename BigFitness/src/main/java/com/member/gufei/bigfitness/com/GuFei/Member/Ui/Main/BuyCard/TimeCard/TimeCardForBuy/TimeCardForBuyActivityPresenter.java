...
public class TimeCardForBuyActivityPresenter extends RxPresenter<TimeCardForBuyActivityContract.View> implements TimeCardForBuyActivityContract.Presenter {
    ...
    @Inject
    public TimeCardForBuyActivityPresenter(Api api) {
        this.api = api;
    }
