 ...
 *
 * */
public class GyClassEvaluationingActivity extends BaseActivity<GyClassEvaluationingActivityPresenter> implements SpinnerPopContract, GyClassEvaluationingActivityContract.View {
...
//
        ...
        FreeLessonId = intent.getStringExtra(PUT_STR + "FreeLessonId");
        FreeLessonName = intent.getStringExtra(PUT_STR + "FreeLessonName");
//
...
//
                mPresenter.FreeLessonEvaluate(MemberId,
                        ClubId,
                        token,
                        FreeLessonId,
                        String.valueOf(mStar),
                        editEvaluate.getText().toString(),
                        imgsrc,
