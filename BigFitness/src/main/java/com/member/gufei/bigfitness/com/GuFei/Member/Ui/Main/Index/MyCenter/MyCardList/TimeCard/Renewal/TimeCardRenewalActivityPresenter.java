...
public class TimeCardRenewalActivityPresenter extends RxPresenter<TimeCardRenewalActivityContract.View> implements TimeCardRenewalActivityContract.Presenter {
    ...
    @Inject
    public TimeCardRenewalActivityPresenter(Api api) {
        this.api = api;
    }
