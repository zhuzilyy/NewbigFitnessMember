package com.member.gufei.bigfitness.com.GuFei.Member.Ui.Main.Index.MyCenter.MyPrivateTeaching.DetailsStale;
...
public class MyPrivateDetailsStaleActivityPresenter extends RxPresenter<MyPrivateDetailsStaleActivityContract.View> implements MyPrivateDetailsStaleActivityContract.Presenter {
    ...
    @Inject
    public MyPrivateDetailsStaleActivityPresenter(Api api) {
        this.api = api;
    }
