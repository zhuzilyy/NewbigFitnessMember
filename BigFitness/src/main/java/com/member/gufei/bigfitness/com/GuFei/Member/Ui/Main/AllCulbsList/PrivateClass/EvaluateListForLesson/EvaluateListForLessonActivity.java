...
public class EvaluateListForLessonActivity extends BaseActivity<EvaluateListForLessonActivityPresenter> implements EvaluateListForLessonActivityContract.View {
    ...
    private CommonAdapter<ClubLessonEvaluateStarTotalBean.RowsBean> commonAdapter;
    private List<ClubLessonEvaluateStarTotalBean.RowsBean> datas = new ArrayList<ClubLessonEvaluateStarTotalBean.RowsBean>();
    ...
    protected void initView() {
        ...
        commonAdapter = new CommonAdapter<ClubLessonEvaluateStarTotalBean.RowsBean>(R.layout.cardview_member_ecaluate, mContext, datas) {
            /**
             ...
             */
            @Override
            protected void convert(ViewHolder holder, final ClubLessonEvaluateStarTotalBean.RowsBean dataBean, int position) {
...
//        commonAdapterMy.setShowFooter(false);
    ...
    private void getList() {
        ...
        mPresenter.getClubLessonEvaluateList(String.valueOf(UserId),
    ...
    @Override
    public void succeed(ClubLessonEvaluateStarTotalBean clubLessonEvaluateStarTotalBean) {
        TotalPage = clubLessonEvaluateStarTotalBean.getTotalPage();
        ProgressBar childBar1 = new ProgressBar(mContext,
                GetcClculate(clubLessonEvaluateStarTotalBean.getStarTotal().getOneStartCount(), clubLessonEvaluateStarTotalBean.getStarTotal().getTotalEvalCount()));
        ProgressBar1.addView(childBar1);

        ProgressBar childBar2 = new ProgressBar(mContext,
                GetcClculate(clubLessonEvaluateStarTotalBean.getStarTotal().getTwoStartCount(), clubLessonEvaluateStarTotalBean.getStarTotal().getTotalEvalCount()));
        ProgressBar2.addView(childBar2);

        ProgressBar childBar3 = new ProgressBar(mContext,
                GetcClculate(clubLessonEvaluateStarTotalBean.getStarTotal().getThreeStartCount(), clubLessonEvaluateStarTotalBean.getStarTotal().getTotalEvalCount()));
        ProgressBar3.addView(childBar3);

        ProgressBar childBar4 = new ProgressBar(mContext,
                GetcClculate(clubLessonEvaluateStarTotalBean.getStarTotal().getFourStartCount(), clubLessonEvaluateStarTotalBean.getStarTotal().getTotalEvalCount()));
        ProgressBar4.addView(childBar4);

        ProgressBar childBar5 = new ProgressBar(mContext,
                GetcClculate(clubLessonEvaluateStarTotalBean.getStarTotal().getFiveStartCount(), clubLessonEvaluateStarTotalBean.getStarTotal().getTotalEvalCount()));
        progressBar5.addView(childBar5);


        textNumber5.setText(clubLessonEvaluateStarTotalBean.getStarTotal().getFiveStartCount() + "");
        textNumber4.setText(clubLessonEvaluateStarTotalBean.getStarTotal().getFourStartCount() + "");
        textNumber3.setText(clubLessonEvaluateStarTotalBean.getStarTotal().getThreeStartCount() + "");
        textNumber2.setText(clubLessonEvaluateStarTotalBean.getStarTotal().getTwoStartCount() + "");
        textNumber1.setText(clubLessonEvaluateStarTotalBean.getStarTotal().getOneStartCount() + "");
        String NumEvaText = "";
        switch (mStar) {
            case 1:
                NumEvaText = "(" + mStar + "星),共" + clubLessonEvaluateStarTotalBean.getStarTotal().getOneStartCount() + "条";
                break;
            case 2:
                NumEvaText = "(" + mStar + "星),共" + clubLessonEvaluateStarTotalBean.getStarTotal().getTwoStartCount() + "条";
                break;
            case 3:
                NumEvaText = "(" + mStar + "星),共" + clubLessonEvaluateStarTotalBean.getStarTotal().getThreeStartCount() + "条";
                break;
            case 4:
                NumEvaText = "(" + mStar + "星),共" + clubLessonEvaluateStarTotalBean.getStarTotal().getFourStartCount() + "条";
                break;
            case 5:
                NumEvaText = "(" + mStar + "星),共" + clubLessonEvaluateStarTotalBean.getStarTotal().getFiveStartCount() + "条";
                break;
        }
        textNumEvaluate.setText(NumEvaText);
        textNumberTotal.setText(clubLessonEvaluateStarTotalBean.getStarTotal().getTotalEvalCount() + "人");


        imgNumberStar.setStar((float) clubLessonEvaluateStarTotalBean.getStarTotal().getAvgStarLevel());

        swipeRefreshLayout.setRefreshing(false);
        if (clubLessonEvaluateStarTotalBean.getRows().size() != 0) {
            datas = clubLessonEvaluateStarTotalBean.getRows();
            if (Page == 1) {
