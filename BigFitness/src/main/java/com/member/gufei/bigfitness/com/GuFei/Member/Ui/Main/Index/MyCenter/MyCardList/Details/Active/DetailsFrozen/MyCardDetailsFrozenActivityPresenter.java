...
public class MyCardDetailsFrozenActivityPresenter extends RxPresenter<MyCardDetailsFrozenActivityContract.View> implements MyCardDetailsFrozenActivityContract.Presenter {
    ...
    @Inject
    public MyCardDetailsFrozenActivityPresenter(Api api) {
        this.api = api;
    }
