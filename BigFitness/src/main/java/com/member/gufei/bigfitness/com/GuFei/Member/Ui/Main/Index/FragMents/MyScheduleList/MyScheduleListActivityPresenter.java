...
public class MyScheduleListActivityPresenter extends RxPresenter<MyScheduleListActivityContract.View> implements MyScheduleListActivityContract.Presenter {
    ...
    @Inject
    public MyScheduleListActivityPresenter(Api api) {
        this.api = api;
    }
