...
public class MyPrivateRenewalOrderActivityPresenter extends RxPresenter<MyPrivateRenewalOrderActivityContract.View> implements MyPrivateRenewalOrderActivityContract.Presenter {
    ...
    @Inject
    public MyPrivateRenewalOrderActivityPresenter(Api api) {
        this.api = api;
    }
