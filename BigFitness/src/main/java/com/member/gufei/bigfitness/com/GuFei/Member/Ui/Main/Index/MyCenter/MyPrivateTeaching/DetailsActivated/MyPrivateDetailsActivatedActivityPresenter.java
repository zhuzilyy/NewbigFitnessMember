...
public class MyPrivateDetailsActivatedActivityPresenter extends RxPresenter<MyPrivateDetailsActivatedActivityContract.View> implements MyPrivateDetailsActivatedActivityContract.Presenter {
    ...
    @Inject
    public MyPrivateDetailsActivatedActivityPresenter(Api api) {
        this.api = api;
    }

    @Override
    public void appGetMyMemberLessonDetail(String APPUserId, String ClubId, String Id, String Status, String token) {
        Subscription subscription = api.appGetMyMemberLessonDetail(APPUserId  ,ClubId ,Id,Status,token)
