 ...
 */
public class WeekDViewCopy extends View {
    ...
    private int mTodayBackgroundColor = Color.rgb(14,22,45);
    ...
    private int mEventTextColor = Color.rgb(14,22,45);;
    private int mEventPadding = 8;
    private int mHeaderColumnBackgroundColor = Color.rgb(14,22,45);
...
//            oldX = 0;
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            if (mCurrentScrollDirection == WeekDViewCopy.Direction.NONE) {
                if (Math.abs(distanceX) > Math.abs(distanceY)) {
                    mCurrentScrollDirection = WeekDViewCopy.Direction.HORIZONTAL;
                    mCurrentFlingDirection = WeekDViewCopy.Direction.HORIZONTAL;


                } else {
                    mCurrentFlingDirection = WeekDViewCopy.Direction.VERTICAL;
                    mCurrentScrollDirection = WeekDViewCopy.Direction.VERTICAL;
                }
            }
            ...
            if (mCurrentScrollDirection != WeekDViewCopy.Direction.VERTICAL) {
...
//                Log.e("原点:", oldX + "");
            ...
            } else if (mCurrentScrollDirection == WeekDViewCopy.Direction.VERTICAL && mCurrentScrollDirection != WeekDViewCopy.Direction.HORIZONTAL) {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            if (mCurrentFlingDirection == WeekDViewCopy.Direction.HORIZONTAL) {


            } else if (mCurrentFlingDirection == WeekDViewCopy.Direction.VERTICAL) {
...
//            ViewCompat.postInvalidateOnAnimation(WeekNoHeaderView.this);
    ...
    public WeekDViewCopy(Context context) {
        this(context, null);
    }

    public WeekDViewCopy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WeekDViewCopy(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mHeaderColumnBackgroundColor = a.getColor(R.styleable.WeekView_headerColumnBackgroundCopy, mHeaderColumnBackgroundColor);
...
//                        mCurrentOrigin.x = mCurrentOrigin.x + (mWidthPerDay + mColumnGap) * 7;
     ...
     * </p>
     *
     * @param length Supported values are {@link WeekDViewCopy#LENGTH_SHORT} and
     *               {@link WeekDViewCopy#LENGTH_LONG}.
     */
    @Deprecated
...
//                int nearestOrigin = (int) (mCurrentOrigin.x -  leftDays * (mWidthPerDay + mColumnGap));
                ...
                ViewCompat.postInvalidateOnAnimation(WeekDViewCopy.this);
            }
