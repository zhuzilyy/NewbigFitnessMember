 ...
 */
public class MemberWeekView extends View {
...
//            }
    ...
    public MemberWeekView(Context context) {
        this(context, null);
    }

    public MemberWeekView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MemberWeekView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        }
     ...
     * </p>
     *
     * @param length Supported values are {@link MemberWeekView#LENGTH_SHORT} and
     *               {@link MemberWeekView#LENGTH_LONG}.
     */
    @Deprecated
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (mCurrentScrollDirection == Direction.HORIZONTAL) {
                ...
                ViewCompat.postInvalidateOnAnimation(MemberWeekView.this);
            }
